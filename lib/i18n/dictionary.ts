...
export const dictionaries: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    submit_subject_primary_label: "主领域 *",
    submit_subject_secondary_label: "次领域（可选）",
    submit_subject_select_placeholder: "请选择",
    submit_subject_secondary_none_option: "不填",
  ...
  en: {
    ...
    submit_subject_primary_label: "Primary Subject Area *",
    submit_subject_secondary_label: "Secondary Subject Area (optional)",
    submit_subject_select_placeholder: "Please select",
    submit_subject_secondary_none_option: "None",
    submit_subject_secondary_hint: "Must be different from the primary subject area",
